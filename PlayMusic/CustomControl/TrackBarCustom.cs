...
namespace PlayMusic
{
    ...
    public partial class TrackBarCustom : Control
    {
        #region Events
        ...
        /// <param name="value">The current value.</param>B
        public TrackBarCustom(decimal min, decimal max, decimal value)
        {
            InitializeComponent();
        ...
        /// Initializes a new instance of the <see cref="ColorSlider"/> class.
        /// </summary>
        public TrackBarCustom() : this(0, 100, 30) { }
